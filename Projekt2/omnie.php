		...
		<header>
			...
			<div class="content">
				<div class="mainContent">
					<section>
						<article id="html5">
							<h2>Tu sa jakies informacje o tworcy strony</h2>
						...
						<article id="css3">
							<h2>Tu kontynuacja</h2>

							
							<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of "de Finibus Bonorum et Malorum" (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem Ipsum, "Lorem ipsum dolor sit amet..", comes from a line in section 1.10.32.orem Ipsum comes from sections 1.10.32 and 1.10.33 of "de Finibus Bonorum et Malorum" (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. </p>
						</article>
					</section>
				</div>
				...
				<div class="sidebar">
					<aside>
						<figure>
							<img src="php.png">
							<figcaption>Jakies zdjecie</figcaption>
						</figure>
						<h2>Jakis opis</h2>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut dictum augue ornare neque finibus, at pellentesque risus posuere. Vestibulum vitae eleifend massa. Donec luctus eget felis sed aliquet. Vivamus sed placerat tortor. Sed nec sollicitudin nulla. Ut sit amet sem justo. Nam finibus, leo ut molestie laoreet, sapien erat maximus metus, ac dapibus eros lacus et magna. Donec felis libero, aliquam vel semper sit amet, tristique vel justo. Proin varius suscipit venenatis. Fusce ultrices iaculis ullamcorper. In nec varius orci, eu dictum orci.</p>
					</aside>
				</div>
			</div>
